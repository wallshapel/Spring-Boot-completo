...
public class PublicacionControlador {
	...
	public PublicacionRespuesta listarPublicaciones(
			...
			@RequestParam(value = "pageSize", defaultValue = AppConstantes.NUMERO_DE_REGISTROS_POR_DEFECTO, required = false) int medidaDePagina,
			@RequestParam(value = "sortBy", defaultValue = AppConstantes.ORDENAR_POR_CAMPO_POR_DEFECTO, required = false) String ordenarPor,
	...
	public ResponseEntity<String> eliminarPublicacion(@PathVariable(name = "id") long id) {
		...
		return new ResponseEntity<>("Publicación eliminada con éxito", HttpStatus.NO_CONTENT);
	}
}